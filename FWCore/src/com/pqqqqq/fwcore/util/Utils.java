...
public class Utils {
	...
	public static ItemStack createBook(boolean signed, Book book) {
		...
		net.minecraft.server.v1_4_R1.ItemStack newStack = CraftItemStack.asNMSCopy(b);
	...
	public static Book getBook(ItemStack book) {
		net.minecraft.server.v1_4_R1.ItemStack nmsStack = CraftItemStack.asNMSCopy(book);
