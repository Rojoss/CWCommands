...
public class BroadcastCmd implements CommandClass {
	...
	public boolean execute(CommandSender sender, Command cmd, String lbl, String[] cmdArgs) {
		...
		if (prefix) {
			msg = "" + ChatColor.DARK_GRAY + ChatColor.BOLD + "[" + ChatColor.DARK_RED + ChatColor.BOLD + "CW BC" + ChatColor.DARK_GRAY
					+ ChatColor.BOLD + "] " + ChatColor.GOLD + ChatColor.BOLD + message;
		} else {
			msg = message;
		}
