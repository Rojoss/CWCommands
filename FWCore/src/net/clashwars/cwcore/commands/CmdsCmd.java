...
public class CmdsCmd implements CommandClass {
	...
	public boolean execute(CommandSender sender, Command cmd, String lbl, String[] cmdArgs) {
		...
		sender.sendMessage(ChatColor.DARK_GRAY + "=====  " + ChatColor.DARK_RED + "CW Commands list for " + ChatColor.GRAY + plugin + ChatColor.RED
				+ " page: " + ChatColor.GRAY + "[" + ChatColor.LIGHT_PURPLE + page + ChatColor.DARK_GRAY + "/" + ChatColor.DARK_PURPLE + pages
		...
		if (page < pages) {
			...
			sender.sendMessage(ChatColor.DARK_GRAY + "===  " + ChatColor.DARK_RED + "~Last Page~" + ChatColor.GRAY + " Use " + ChatColor.DARK_GRAY
					+ "/<cmd> -h" + ChatColor.GRAY + " for cmd help!" + ChatColor.DARK_GRAY + "  ===");
		}
		return true;
	}
